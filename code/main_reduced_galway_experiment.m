...
for k = 1: no_of_blocks
    ...
    for i = 1:n_of_trials
        ...
        [y_1,y_2,s1,s2,y_mc_hu,y_mc_lu,decision_module_crossed,...
            ...
            (coh,decision_module_threshold,mc_module_delay, dynamics_and_results(index).c);
        ...
        if(index+1<=n_of_trials*no_of_blocks && across_trial_effect)
            dynamics_and_results(index+1).c= calculate_control_value(energy);
        end
        ...
        clearvars -except dynamics_and_results k i dt trial_length stim_onset...
            ...
            x_gather motor_preparation_module_threshold_eye
        %%%%
    end
